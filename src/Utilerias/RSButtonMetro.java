...
public class RSButtonMetro extends JButton implements MouseListener, MouseMotionListener {
    ...
    private Color colorNormal = new Color(28,37,47);
    private Color colorPressed = new Color(133,146,158);   
    private Color colorHover = new Color(28,37,47);  
     //133,146,158
    private Border bordeMoved = javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 3, new java.awt.Color(255, 255, 255));
    /**
     * Color para el texto
     */
  
    private Color colorTextNormal = new Color(255, 255, 255);
    private Color colorTextPressed = new Color(133,146,158);
    private Color colorTextHover = new Color(133,146,158);
    
    private Font f = new Font("Century Gothic", Font.BOLD, 18);
