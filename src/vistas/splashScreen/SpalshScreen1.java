...
package vistas.splashScreen;

/**
 *
 * @author RoXen
 */
public class SpalshScreen1 extends javax.swing.JFrame {

    /**
     * Creates new form SpalshScreen
     */
    public SpalshScreen1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        loadingnumber.setForeground(new java.awt.Color(153, 153, 153));
        ...
        jLabel_inven1.setForeground(new java.awt.Color(153, 153, 153));
        jLabel_inven1.setText("Sistema de Reservaciones Hotel Paraiso Inn");
        jPanel1.add(jLabel_inven1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 720, 50));
        jPanel1.add(rSProgressCircleAnimated1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 250, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpalshScreen1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SpalshScreen1().setVisible(true);
            }
        });
    }
