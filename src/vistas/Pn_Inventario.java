...
//sin lineas verticles
   ...
   private Boolean validarEscritura() {
        ...
        if (!(jt_nombre.getText().equals("Ingresar Nombre")) && !(jt_nombre.getText().equals(""))) {
          ...
          //si el textfield tiene algo diferente a Vacío aparecerá de color negro
        if (!(jt_CantidadStock.getText().equals("Ingresar Cantidad")) && !(jt_nombre.getText().equals(""))) {
            lb_errorStock.setForeground(new Color(84, 110, 122));
        } else {
...
/*
    ...
    private void initComponents() {
        ...
        lb_errorObservaciones.setText("*");
        jPanel1.add(lb_errorObservaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, -1, -1));

        lb_errorNombreProducto.setForeground(new java.awt.Color(84, 110, 122));
        lb_errorNombreProducto.setText("*");
        jPanel1.add(lb_errorNombreProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, -1));

        lb_errorStock.setForeground(new java.awt.Color(84, 110, 122));
        lb_errorStock.setText("*");
        jPanel1.add(lb_errorStock, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, -1, -1));
    ...
    private void btn_IngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_IngresarActionPerformed
     try {
            if (!validarEscritura() == true) {
              ...
              cinv.insertarInventario(jt_nombre.getText(),Integer.parseInt(jt_CantidadStock.getText()), jta_observaciones.getText());
   ...
   try {
           ...
           cinv.actualizarInventario(jt_nombre.getText(), Integer.parseInt(jt_CantidadStock.getText()), jta_observaciones.getText(), Integer.parseInt(lb_Id.getText()));
   ...
   try {
           ...
           ale.jb_aceptar.addActionListener(new ActionListener() {
               ...
               public void actionPerformed(ActionEvent ae) {
                   cinv.eliminarInventario(Integer.parseInt(lb_Id.getText()));
                   tamañoTabla();
                   NewTable = new DefaultTableModel();
                   cTabla();
                   datosIniciales();
